...
dir_ci_full = '/home/calvin/graspy/safronova/ci_8sp7dfg'
initialize(workdir=dir_ci_full,clist=clistordering)
iccut_vals = Rmixaccumulate(calcname='safronova',useCI=True,truncate_eps=0.99).execute(workdir=dir_ci_expanded)
print(iccut_vals)
assert(1==0)
