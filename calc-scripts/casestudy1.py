...
even_2s2p2_exp_split = Rcsfsplit(calcname = 'even',nsplit = 4, splitorbs = range(3,7))
...
for n in range(3,6):
        ...
        LSJ_coupling_odd = JJtoLSJ(calcname= f'odd{n}',use_ci = True, unique = True)
        #should it be f'odd{n}' or 'odd'
        ...
        if n == 6:
                ...
                BC_odd = Rci(calcname= 'oddCI6', #oddCI${n}
                ...
                break
        # transform to LSJ-coupling
        Transform_LSJ_odd = JJtoLSJ(calcname= f'oddCI{n}',use_ci = True, unique = True)
...
for n in range(3,6):
        ...
        # transform to LSJ-coupling
        LSJ_coupling_even = JJtoLSJ(calcname= f'even{n}',use_ci = True, unique = True)
        #should it be f'even{n}' or 'even'
        ...
        if n == 6:
                ...
                break
        # transform to LSJ-coupling
        Transform_LSJ_even = JJtoLSJ(calcname= f'evenCI{n}',use_ci = True, unique = True)
...
n = 6
BT = [Rbiotransform(use_ci=True,calcname_initial = 'oddCI',calcname_final = 'evenCI', transform_all = True),
        #should it be f'oddCI{n}' or 'oddCI', #should it be f'evenCI{n}' or 'evenCI'
        #First the biorthonormal transformations
        Rtransition(use_ci=True,calcname_initial = 'oddCI',calcname_final = 'evenCI',transition_spec = ['E1'])]
        #should it be f'oddCI{n}' or 'oddCI', #should it be f'evenCI{n}' or 'evenCI'
