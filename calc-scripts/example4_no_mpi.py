...
ex4_workdir = 'calc-outputs/example4_mpi'
...
#Rmcdhf(indices_even,orbs=['4*'],specorbs=[''],weighting_method='Standard',runs=100).execute(workdir=ex4_workdir)
...
#Rmcdhf(indices_odd,orbs=['4*'],specorbs=[''],weighting_method='Standard',runs=100).execute(workdir=ex4_workdir)
